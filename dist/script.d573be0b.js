...
["ltr", "lt", "tb", "tb", "t", "tb", "t", "tb", "tr", "lt", "tr", "lt", "tb", "tbr"], ["lrm", "lr", "lt", "tr", "lr", "ltb", "br", "ltr", "lb", "r", "lr", "lb", "tr", "ltr"], ["lb", "a", "br", "lr", "lr", "lt", "tb", "b", "tr", "lbr", "lb", "tr", "l", "r"], ["ltr", "lb", "tr", "lr", "lr", "lr", "ltb", "tr", "lb", "tr", "lt", "br", "lr", "lr"], ["lr", "ltr", "lr", "lr", "lbr", "lb", "tb", "br", "lt", "br", "l", "tb", "br", "lr"], ["lr", "lb", "br", "lb", "tb", "tb", "tb", "tb", "br", "ltr", "lbr", "lt", "t", "br"], ["lr", "lt", "tb", "tr", "lt", "tr", "lt", "t", "tr", "lb", "tb", "r", "lr", "ltr"], ["lr", "lr", "lt", "r", "lr", "lr", "lr", "lr", "lb", "tb", "tb", "br", "lb", "r"], ["l", "r", "lbr", "lb", "br", "lr", "lbr", "lb", "tb", "tr", "lt", "tr", "ltr", "lr"], ["lr", "lr", "lt", "tr", "ltr", "lb", "tb", "tb", "tb", "br", "lr", "lr", "lr", "lr"], ["lr", "lb", "br", "lb", "b", "tb", "t", "tb", "tb", "tb", "r", "lr", "lr", "lr"], ["lb", "tb", "tb", "tb", "tb", "tbr", "lb", "tb", "tb", "tb", "br", "lr", "lb", "br"]]; // Enter the game when pressing enter, if not already in it
...
function game() {
  ...
  oxo.inputs.listenKey('left', function (key) {
    ...
    if (characterPos.x === 6 && characterPos.y === 3) {
      var allCells = document.querySelectorAll('.labyrinthe__cell');

      for (var jeej = 0; jeej < allCells.length; jeej++) {
